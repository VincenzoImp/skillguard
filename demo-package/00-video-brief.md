...
3. The agent submits a low-risk zero-spend request.
...
8. A Solana devnet receipt proves this is a real mediated wallet flow.
...
1:10-2:25  Live proof: pair, approve, block, revoke.
